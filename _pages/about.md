...
I currently intern at [Toyota Research Institute (TRI)](http://www.tri.global/), Ann Arbor, MI this semester (from Sep. 2017 to Dec. 2017). Working in the Materials Research Department, my responsibility  is to fulfill the requirement of materials informatics research in the group. I am utilizing machine learning techniques, especially text mining and natural language processing techniques, for information extraction in the domain of chemical & material science. The goal is to convert unstructured data from sources such as electronic literature and patents to structured knowledge base such as ontology for further material informatics analysis.
