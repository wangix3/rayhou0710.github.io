...
I currently intern at [Toyota Research Institute (TRI)](http://www.tri.global/), Ann Arbor, MI this semester (from Sep. 2017 to Dec. 2017). Working as a materials informatics intern, I am applying machine learning techniques, especially text mining and natural language processing techniques, to information extraction in materials science. The goal is to convert unstructured data in sources such as electronic literature and patents to structured knowledge base such (e.g., ontology) to support further data mining (e.g., what temperature is most suitable for the synthesis of a certain lithium compound?). -->
